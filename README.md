...
WAMP/LAMP/MAMP server and point it to the root `index.html` file here. You
could also build virtualhosts with NGINX or Apache and use them.

If you're like me though and **LOVE** Golang or at least have Go installed on your
machine, I've included a `server.go` file in this directory to run the
...
Navigate to your localhost and you can view the example list live.
